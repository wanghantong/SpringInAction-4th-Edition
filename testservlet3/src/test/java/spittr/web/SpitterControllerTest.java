...
public class SpitterControllerTest {
	...
	public void shouldFailValidationWithNoData() throws Exception {
		...
		mockMvc.perform(post("/spitter/register")).andExpect(status().isOk()).andExpect(view().name("registerForm"))
				.andExpect(model().errorCount(5)).andExpect(model().attributeHasFieldErrors("spitter", "firstName",
