...
package org.quartz.examples.trigger;
...
public class SimpleTriggerExample {
	Logger log = LogManager.getLogger("org.quartz.examples.simples");
	...
	public void run() throws Exception {
		...
		// SimpleTrigger trigger2 = (SimpleTrigger)
		// TriggerBuilder.newTrigger().withIdentity("xx",
		// "xxyy").startAt(startTime).build();
		...
		trigger = (SimpleTrigger) newTrigger().withIdentity("trigger5", "group1")
				.startAt(futureDate(5, IntervalUnit.SECOND)).build();
		...
		// trigger = newTrigger().withIdentity("trigger7",
